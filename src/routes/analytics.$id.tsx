...
function DashboardDetails() {
  ...
  const timeRangeMs = analytics
    ? new Date(analytics.endTime).getTime() - new Date(analytics.startTime).getTime()
    : 0;
  ...
  const chartData = analytics?.buckets.map((bucket) => {
    ...
    return {
      ...
      clicks: bucket.count,
      startLabel: showTimes ? formatTime(startTime) : formatDateShort(startTime),
            ...
            {loading ? (
              ...
              <>
                ...
                <div className="bg-slate-700 rounded-lg p-6 mb-6">
                  ...
                  {analytics && (
                    <div className="mb-2 text-sm text-gray-300">
                      Viewing: <span className="font-mono">{formatDate(analytics.startTime)}</span> to <span className="font-mono">{formatDate(analytics.endTime)}</span>
                    </div>
                  )}
                ...
                <div className="bg-slate-700 rounded-lg p-6">
                  ...
                  {chartData.length === 0 ? (
                    <p className="text-gray-400">No clicks in the selected time range.</p>
                  ) : (
                      ...
                      <BarChart data={chartData} margin={{ top: 10, right: 30, left: 0, bottom: 60 }}>
                        ...
                        <XAxis
                          ...
                          tickFormatter={(time) => {
                            ...
                            return showTimes ? formatTime(d) : formatDateShort(d);
                          }}
                          height={80}
                        />
                        <YAxis stroke="#94a3b8" />
